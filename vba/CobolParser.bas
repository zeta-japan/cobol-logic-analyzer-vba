    ...
    For Each n In nodes
        ...
        ElseIf t = "evaluate" Then
            ...
            If Not hasOther Then
                ...
                e.Add "type", "evaluate"
                e.Add "label", n.Item("expression") & " (・ｽE・ｽY・ｽE・ｽ・ｽE・ｽWHEN・ｽE・ｽﾈゑｿｽ)"
                e.Add "line", n.Item("startLine")
                edges.Add e
            End If
...
Public Function New_ScenarioName(ByVal conditions As Collection, ByVal idx As Long) As String
    If conditions.Count > 0 Then
        New_ScenarioName = "・ｽE・ｽV・ｽE・ｽi・ｽE・ｽ・ｽE・ｽ・ｽE・ｽI" & idx & ": " & JoinCol_(conditions, " / ")
    Else
        New_ScenarioName = "・ｽE・ｽV・ｽE・ｽi・ｽE・ｽ・ｽE・ｽ・ｽE・ｽI" & idx & ": ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾈゑｿｽ"
    End If
End Function
...
Public Function Get_Warnings(ByVal lines As Collection, ByVal rootNodes As Collection) As Collection
    ...
    If rx.Test(sb) Then w.Add "NEXT SENTENCE ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾜまゑｿｽﾄゑｿｽ・ｽE・ｽﾜゑｿｽ・ｽE・ｽB・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽI・ｽE・ｽ[・ｽE・ｽﾌ確・ｽE・ｽF・ｽE・ｽ・ｽE・ｽ・ｽE・ｽK・ｽE・ｽv・ｽE・ｽﾅゑｿｽ・ｽE・ｽB"

    rx.Pattern = "\bGO\s+TO\b"
    If rx.Test(sb) Then w.Add "GO TO ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾜまゑｿｽﾄゑｿｽ・ｽE・ｽﾜゑｿｽ・ｽE・ｽB・ｽE・ｽp・ｽE・ｽX・ｽE・ｽ・ｽE・ｽﾍ鯉ｿｽ・ｽE・ｽﾊゑｿｽ・ｽE・ｽ闢ｮ・ｽE・ｽm・ｽE・ｽF・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾄゑｿｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽB"

    rx.Pattern = "\bPERFORM\b.+\bTHR(U|OUGH)\b"
    If rx.Test(sb) Then w.Add "PERFORM THRU ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾜまゑｿｽﾄゑｿｽ・ｽE・ｽﾜゑｿｽ・ｽE・ｽB・ｽE・ｽi・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾍ囲鯉ｿｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ\・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾆゑｿｽ・ｽE・ｽﾄ抵ｿｽ・ｽE・ｽo・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾄゑｿｽ・ｽE・ｽﾜゑｿｽ・ｽE・ｽB"

    If Get_NodeCount(rootNodes, Array("evaluate")) > 0 Then
        w.Add "EVALUATE ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽWHEN・ｽE・ｽP・ｽE・ｽﾊで抵ｿｽ・ｽE・ｽo・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾄゑｿｽ・ｽE・ｽﾜゑｿｽ・ｽE・ｽB・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾌ排・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾍ・・ｽ・ｽ・ｽE・ｽr・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ[・ｽE・ｽﾎ象でゑｿｽ・ｽE・ｽB"
    End If
    If Get_NodeCount(rootNodes, Array("search")) > 0 Then
        w.Add "SEARCH ・ｽE・ｽ・ｽE・ｽ WHEN ・ｽE・ｽﾍ表・ｽE・ｽf・ｽE・ｽ[・ｽE・ｽ^・ｽE・ｽﾉ依托ｿｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾜゑｿｽ・ｽE・ｽB・ｽE・ｽe・ｽE・ｽX・ｽE・ｽg・ｽE・ｽf・ｽE・ｽ[・ｽE・ｽ^・ｽE・ｽﾝ計・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾉ表・ｽE・ｽ・ｽE・ｽ・ｽE・ｽe・ｽE・ｽﾌ確・ｽE・ｽF・ｽE・ｽ・ｽE・ｽ・ｽE・ｽK・ｽE・ｽv・ｽE・ｽﾅゑｿｽ・ｽE・ｽB"
    End If
    ...
    For Each line In lines
        ...
        End If
    Next line
    If compoundFound Then w.Add "・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ (AND/OR) ・ｽE・ｽﾍ包ｿｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾄゑｿｽ・ｽE・ｽﾜゑｿｽ・ｽE・ｽ・ｽE・ｽB・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾔ暦ｿｽ・ｽE・ｽﾍ手動・ｽE・ｽﾅ確・ｽE・ｽF・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾄゑｿｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽB"

    If mUnclosedFrames > 0 Then
        w.Add "END・ｽE・ｽ蛯ｪ・ｽE・ｽs・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾄゑｿｽ・ｽE・ｽ・ｽE・ｽﾂ能・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾜゑｿｽ・ｽE・ｽB・ｽE・ｽ・ｽE・ｽ・ｽE・ｽN・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ[・ｽE・ｽY・ｽE・ｽﾌブ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽb・ｽE・ｽN・ｽE・ｽ・ｽE・ｽ " & mUnclosedFrames & " ・ｽE・ｽﾂゑｿｽ・ｽE・ｽ・ｽE・ｽﾜゑｿｽ・ｽE・ｽB"
    End If
    If mPathTruncated Then
        w.Add "・ｽE・ｽp・ｽE・ｽX・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ (" & MAX_PATH_STATES & ") ・ｽE・ｽｴゑｿｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾟ、・ｽE・ｽ齦費ｿｽﾌパ・ｽE・ｽX・ｽE・ｽﾍ展・ｽE・ｽJ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾄゑｿｽ・ｽE・ｽﾜゑｿｽ・ｽE・ｽ・ｽE・ｽB"
    End If
...
Public Function Analyze_Full(ByVal source As String, Optional ByVal forcePrefix As String = "", _
    ...
    For Each s In pathStates
        ...
        Else
            tc.Add "inputData", "・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽ・ｽE・ｽﾈゑｿｽ"
        End If
        tc.Add "expectedValue", JoinCol_(actionLabels, " / ")
        If idx = 1 Then tc.Add "priority", "・ｽE・ｽ・ｽE・ｽ" Else tc.Add "priority", "・ｽE・ｽ・ｽE・ｽ"
